package org.ismael.web.controllers;


import jakarta.validation.Valid;
import org.ismael.web.entity.User;
import org.ismael.web.services.UserService;
...
public class UserController {
    ...
    public String viewData(Model model) {
        ...
        model.addAttribute("message", "Esta es una aplicación usando Spring Boot!!!");
        model.addAttribute("user", new User("Luis", "Ismael"));
        return "view";
    }
